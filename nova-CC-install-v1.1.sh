...
REQUIRED_PACKAGES="python-support python-mysqldb mysql-server nova-api nova-network nova-objectstore nova-scheduler nova-compute unzip vim euca2ools glance"
